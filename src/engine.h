...
class Engine {
    private:
        ...
        // Shapes
        vector<unique_ptr<Circle>> meteor;
        vector<unique_ptr<Shape>> star;
        vector<unique_ptr<Shape>> earth;
        vector<unique_ptr<Shape>> mars;
        vector<unique_ptr<Shape>> square;
        unique_ptr<Rect> score;
        unique_ptr<Rect> user;
        unique_ptr<Circle> user1;
        unique_ptr<Circle> user2;
        unique_ptr<Circle> user3;
        unique_ptr<Circle> user4;
